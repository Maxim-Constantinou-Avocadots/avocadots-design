...
Static prototype of the Avocadots homepage redesign. Design baseline **V0.11**.
...
dist/
  ...
  styles.css      full cascade, layered by revision (V0.8 → V0.11 blocks append at the end)
...
The six platform partners render as their real logo tiles rather than text wordmarks.
