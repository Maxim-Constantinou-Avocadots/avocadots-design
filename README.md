...
Static prototype of the Avocadots homepage redesign. Design baseline **V0.15**.
...
dist/
  ...
  styles.css      full cascade, layered by revision (V0.8 → V0.15 blocks append at the end)
